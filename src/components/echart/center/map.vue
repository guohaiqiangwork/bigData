...
export default {
  ...
  methods: {
    ...
    drawPie() {
      ...
      var series = [];
      [["中国北京", BJData]].forEach(function(item, i) {
        series.push(
          {
            name: "攻击线1",
            type: "lines",
      ...
      let tips = this.tips;
      let option = {
        backgroundColor: "#060d22", //总体背景颜色
        tooltip: {
          trigger: "item",
          backgroundColor: "#1540a1", //提示框底色
          borderColor: "#FFFFCC",
          showDelay: 0,
          hideDelay: 0,
          enterable: true,
          ...
          formatter: function(params, ticket, callback) {
            ...
            if (name != "") {
              res =
                ...
                name +
                "</span><br/>当前地点捕捉到的最新url为：<br/>" +
                countryUrl[name];
            } else if (params.color === "red") {
              //攻击线2  红色 表示发出的攻击请求

              res = "<span style='color:#fff;'></span>发出攻击请求<br/>";
            } else {
              ...
              res =
                "<span style='color:#fff;'></span>捕获的url为：<br/>" +
                countryUrl[random];
            }
